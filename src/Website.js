...
class Website extends Component{
    ...
    render(){
        return(
            ...
            <div className='a'>
                <h2>Our Tours</h2>
                {this.state.datas.map((data,i)=><div key={data.id}><div className='b'><img src={data.image}/>
                <div className='c'>
                    <h4>{data.name}</h4>
                    <h6>${data.price}</h6>
                </div>
                <div>
                <p>{this.state.show?data.info:data.info.slice(0,200)}
                <button className='btn btn-secondary'onClick={this.handletoggle}>{this.state.show?'show less':'show more'}</button>
                </p>
                </div>
                </div>
                </div>)}
                ...
                <center><button className='btn btn-outline-danger m-4' onClick={()=>this.handleDelete(i)}>NOT INTERESTED</button></center>
